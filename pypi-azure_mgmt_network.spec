...
Source0  : https://files.pythonhosted.org/packages/19/a3/8d2fa6e33107354c8cd2abcca4e0f02138bda4c6024984ae5fce5cf23b27/azure_mgmt_network-28.1.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_network-28.1.0
cd %{_builddir}/azure_mgmt_network-28.1.0
pushd ..
cp -a azure_mgmt_network-28.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735093864
