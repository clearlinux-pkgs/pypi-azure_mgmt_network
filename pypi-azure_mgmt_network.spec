...
Source0  : https://files.pythonhosted.org/packages/e3/bb/8e98bbf5f0d2c233268631c73858c066b5f883f7dda5b298d2a09c4cdc92/azure-mgmt-network-25.4.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-network-25.4.0
cd %{_builddir}/azure-mgmt-network-25.4.0
pushd ..
cp -a azure-mgmt-network-25.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716833097
