...
Source0  : https://files.pythonhosted.org/packages/44/9c/02b7938dddf0ad3bb1f6e231d72e91ccbdb6b9bf65251e7aa04c8b0a0cb1/azure-mgmt-network-21.0.1.zip
...
%prep
%setup -q -n azure-mgmt-network-21.0.1
cd %{_builddir}/azure-mgmt-network-21.0.1
pushd ..
cp -a azure-mgmt-network-21.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660747524
