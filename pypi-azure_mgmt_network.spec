...
Source0  : https://files.pythonhosted.org/packages/26/20/c09aefc1f7a14b90161589b0dc9aeaef60b4b8a5edcad2e06f8af9086018/azure-mgmt-network-25.3.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-network-25.3.0
cd %{_builddir}/azure-mgmt-network-25.3.0
pushd ..
cp -a azure-mgmt-network-25.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708614845
