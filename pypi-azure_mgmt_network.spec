...
Source0  : https://files.pythonhosted.org/packages/bc/79/93634adfaf3005d8417c05a0683f1227a967a4817391969dbfd9d32f77b1/azure-mgmt-network-22.0.0.zip
...
%prep
%setup -q -n azure-mgmt-network-22.0.0
cd %{_builddir}/azure-mgmt-network-22.0.0
pushd ..
cp -a azure-mgmt-network-22.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665692094
