...
Source0  : https://files.pythonhosted.org/packages/8e/5f/a0c0c900e0c36c4c183384ea304f8fec58025eed6cf5c79cd0ab3f266394/azure-mgmt-network-26.0.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-network-26.0.0
cd %{_builddir}/azure-mgmt-network-26.0.0
pushd ..
cp -a azure-mgmt-network-26.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721922032
