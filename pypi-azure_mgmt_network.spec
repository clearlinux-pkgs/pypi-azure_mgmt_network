...
Version  : 29.0.0
Release  : 40
URL      : https://files.pythonhosted.org/packages/19/b6/fbd5320047659af1bd26aa55529dbe5a8c2faeeb62a8aadc72e1dd88f66c/azure_mgmt_network-29.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/19/b6/fbd5320047659af1bd26aa55529dbe5a8c2faeeb62a8aadc72e1dd88f66c/azure_mgmt_network-29.0.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_network-29.0.0
cd %{_builddir}/azure_mgmt_network-29.0.0
pushd ..
cp -a azure_mgmt_network-29.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748009591
...
cp %{_builddir}/azure_mgmt_network-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_network/7aea571d641549de89730da8e7ff5a6940c5526b || :
